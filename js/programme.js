...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.history.replaceState({year: currentYear, month: currentMonth}, '', `?year=${currentYear}&month=${currentMonth}`);
    ...
    function changeMonth(delta) {
        ...
        window.history.pushState({year: currentYear, month: currentMonth}, '', `?year=${currentYear}&month=${currentMonth}`);
