...
## 4. Tonight's Duties (`todo/tonights_duties.md`) [DONE]
...
## 5. Documents Page (`todo/documents_feature.md`) [DONE]
...
## 6. Document History (`todo/document-history.md`) [DONE]
...
## 7. Print Stylesheet (`todo/print-stylesheet.md`) [DONE]
...
## 11. Secure System Reset (`todo/secure_system_reset.md`) [DONE]
